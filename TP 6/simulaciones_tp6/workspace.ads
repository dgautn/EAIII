<ADSWorkspace Revision="2" Version="100">
    <Workspace Name="">
        ...
        <Data_Files Name="dc_annotation\%Aplicada%I%I%I_lib_transistor_schematic\annotation_1.xml" />
        <Data_Files Name="dc_annotation\%Aplicada%I%I%I_lib_transistor_schematic\annotation_map.xml" />
        <Data_Files Name="transistor.ds" />
        <Data_Files Name="transistor_data\logFile.txt" />
        ...
        <Cell Name="AplicadaIII_lib:cell_1" />
        <Cell Name="AplicadaIII_lib:transistor" />
        <Cell Name="AplicadaIII_lib:adapt_smith" />
        <Cell Name="AplicadaIII_lib:amp_rf_adaptado" />
    </Workspace>
</ADSWorkspace>
